...
•**Temperature Data** Using the maxtempdataset granted by loading the fpp2 package, there are maximum annual temperature data in Celsius.  For more information, use help(maxtemp).  To see what you're looking at, execute the command in 'Examples' in the help document.
...
maxtemp90 = window(maxtemp, start = 1990, end = 2016)
autoplot(maxtemp90)
```
...
# Always plot the data first! 
plot(maxtemp90,ylab = "Max Temp", xlab = "Year", main = "Maximum Temperatures")


#fit 3 different simple exponential smoothing models ... how are they different?
# what does the h paramter do? 
fit1temp = ses(maxtemp90, initial = "simple",alpha = .5,h = 5)
fit2temp = ses(maxtemp90,initial = "simple",alpha = .6, h = 5)
fit3temp = ses(maxtemp90, h = 26) #defaults

#Reset the plot
plot(maxtemp90,ylab = "Max Temp", xlab = "Year", type = "o", xlim = c(1990, 2021),ylim = c(15,50), main = "Maximum Temperatiures")

#Plot the estimated values from the models .. the "fitted" values are the training values.
lines(fitted(fit1temp), col = "blue", type = "o")
#lines(fitted(fit2temp), col = "red", type = "o")
#lines(fitted(fit3temp), col = "darkgreen", type = "o")

# the  $mean values are the forecasts.
lines(fit1temp$mean, col = "blue", type = "o")
lines(fit2temp$mean, col = "red", type = "o")
lines(fit3temp$mean, col = "darkgreen", type = "o")
